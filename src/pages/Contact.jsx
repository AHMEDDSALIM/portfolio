...
function Contact() {
  function handleSendEmail(e) {
    ...
    window.open(
      `mailto:ahmed.d.s4lim@gmail.com?subject=${encodeURIComponent(
        data.subject
  ...
  return (
    <div className="flex justify-center mt-10">
      <div className="flex flex-col items-center w-11/12">
        <h1 className="text-[#34495E] text-3xl mb-10">Contact me</h1>
        <motion.div
          className="flex flex-col items-center card2 w-full md:w-3/4 rounded-lg p-5 gap-5"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        >
          ...
          <div>
            <ul className="flex gap-3">
              <li>
                <a href="https://github.com/AHMEDDSALIM" target="_blank">
                  <svg
              ...
              <li>
                <a
                  href="https://www.instagram.com/ahmed.d.salim/"
                  target="_blank"
                >
                  <svg
                    className="hover:scale-110 transition-all fill-[#222831]"
